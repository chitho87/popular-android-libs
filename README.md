...
|[Retrofit](http://square.github.io/retrofit/) | Làm việc với http API| Các tham số request và response được chuyển thành đối tượng Java, code tường minh, dễ thực hiện, hỗ trợ đầy đủ cấc giao thức.| - Nếu muốn tự xử lý dữ liệu nhận về có vẻ khó khăn. - Cancel 1 request chưa  hỗ trợ| ------------       |
